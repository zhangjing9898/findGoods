window.skins={};
                ...
                generateEUI.skins = {"eui.Button":"resource/eui_skins/ButtonSkin.exml","eui.CheckBox":"resource/eui_skins/CheckBoxSkin.exml","eui.HScrollBar":"resource/eui_skins/HScrollBarSkin.exml","eui.HSlider":"resource/eui_skins/HSliderSkin.exml","eui.Panel":"resource/eui_skins/PanelSkin.exml","eui.TextInput":"resource/eui_skins/TextInputSkin.exml","eui.ProgressBar":"resource/eui_skins/ProgressBarSkin.exml","eui.RadioButton":"resource/eui_skins/RadioButtonSkin.exml","eui.Scroller":"resource/eui_skins/ScrollerSkin.exml","eui.ToggleSwitch":"resource/eui_skins/ToggleSwitchSkin.exml","eui.VScrollBar":"resource/eui_skins/VScrollBarSkin.exml","eui.VSlider":"resource/eui_skins/VSliderSkin.exml","eui.ItemRenderer":"resource/eui_skins/ItemRendererSkin.exml","StartScene":"resource/skins/StartScene.exml","mainScene":"resource/skins/mainScene.exml","MainScene":"resource/skins/MainScene.exml","prize":"resource/skins/prize.exml"};generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function MainSceneSkin() {
		_super.call(this);
		this.skinParts = ["rugImg","windowImg","tableImg","sofaImg","pizzaImg","scrawlImg","picImg","bedImg","mCalf","mThigh","mHand","smokeGroup","man","gLeg","gHand","mHand0","girl","app1","app2","app3","app4","app5","app7","app9","app10","app12","app11","app13","app14","app15","app16","c1","c2","c3","c4","c5","c6","c7_1","c7_2","shoeGroup","c8_1","c8_2","sockGroup","c9","c10","c11","c12","c13","c14","c15","c16","c17","c18","tip","viewportGroup","scroller","rr","lr","restRect","total","prizeShowGroup","directionGroup","closeBtn","msg","icon","img","appName","urlBtn","downloadGroup","popPrizeGroup","prizeComponent"];
	...
	_proto.viewportGroup_i = function () {
		...
		t.elementsContent = [this.rugImg_i(),this._MyImage1_i(),this.windowImg_i(),this.tableImg_i(),this.sofaImg_i(),this._MyImage2_i(),this._MyImage3_i(),this.pizzaImg_i(),this.scrawlImg_i(),this.picImg_i(),this._MyImage4_i(),this.bedImg_i(),this.man_i(),this.girl_i(),this.app1_i(),this._MyImage12_i(),this.app2_i(),this.app3_i(),this.app4_i(),this.app5_i(),this.app7_i(),this.app9_i(),this.app10_i(),this.app12_i(),this.app11_i(),this.app13_i(),this.app14_i(),this.app15_i(),this.app16_i(),this.c1_i(),this.c2_i(),this.c3_i(),this.c4_i(),this.c5_i(),this.c6_i(),this.shoeGroup_i(),this.sockGroup_i(),this.c9_i(),this.c10_i(),this.c11_i(),this.c12_i(),this.c13_i(),this.c14_i(),this.c15_i(),this.c16_i(),this.c17_i(),this.c18_i(),this.tip_i(),this._Group1_i(),this._Group2_i()];
		return t;
	};
	...
	_proto.man_i = function () {
		...
		t.x = 616;
		t.y = 470;
		t.elementsContent = [this._MyImage5_i(),this._MyImage6_i(),this.mCalf_i(),this.mThigh_i(),this.mHand_i(),this.smokeGroup_i(),this._Rect3_i()];
		return t;
	};
	...
	_proto.smokeGroup_i = function () {
		...
		t.x = 64.33;
		t.y = 8.98;
		t.elementsContent = [this._MyImage7_i(),this._MyImage8_i(),this._MyImage9_i()];
		return t;
	};
	...
	_proto.girl_i = function () {
		...
		t.x = 1134;
		t.y = 662;
		t.elementsContent = [this.gLeg_i(),this._MyImage10_i(),this._MyImage11_i(),this.gHand_i(),this.mHand0_i()];
		return t;
	};
	...
	_proto.popPrizeGroup_i = function () {
		...
		t.visible = false;
		t.width = 720;
		t.elementsContent = [this._Rect6_i(),this._Group4_i()];
		return t;
	};
	...
	_proto._Group4_i = function () {
		...
		t.x = 40;
		t.y = 222;
		t.elementsContent = [this._Rect7_i(),this._MyImage13_i(),this.closeBtn_i(),this.msg_i(),this._Group3_i(),this.downloadGroup_i()];
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.width = 640;
		t.y = 222;
		t.elementsContent = [this._Rect2_i(),this._Image1_i(),this.closeBtn_i(),this.msg_i(),this._Group1_i(),this.url_i(),this._Label1_i(),this._Label2_i()];
		return t;
	};
	_proto._Rect2_i = function () {
		var t = new eui.Rect();
	...
	function RuleSkin() {
		_super.call(this);
		this.skinParts = ["list_rule","ruleScroller","closeBtn"];
		
		this.height = 880;
		this.width = 640;
		this.elementsContent = [this._Rect1_i(),this._Image1_i(),this.ruleScroller_i(),this.closeBtn_i()];
	}
	...
	_proto.ruleScroller_i = function () {
		...
		t.x = 60;
		t.y = 288;
		t.viewport = this.list_rule_i();
		return t;
	};
	_proto.list_rule_i = function () {
		var t = new eui.List();
		this.list_rule = t;
		t.itemRendererSkinName = RuleItemSkin;
		return t;
	};
	_proto.closeBtn_i = function () {
		var t = new eui.Button();
	...
	return RuleSkin;
})(eui.Skin);generateEUI.paths['resource/skins/RuleItem.exml'] = window.RuleItemSkin = (function (_super) {
	__extends(RuleItemSkin, _super);
	function RuleItemSkin() {
		_super.call(this);
		this.skinParts = [];
	...
	var _proto = RuleItemSkin.prototype;
	...
	function StartSceneSkin() {
		...
		this.height = 1280;
		this.width = 720;
		this.elementsContent = [this._Rect1_i(),this._Image1_i(),this._Image2_i(),this.musicImg_i(),this.pjImg_i(),this._Image3_i(),this.sbImg_i(),this._Image4_i(),this._Image5_i(),this.btnGroup_i(),this.rewardBtn_i(),this.popRewardGroup_i(),this.popRuleGroup_i()];
	}
